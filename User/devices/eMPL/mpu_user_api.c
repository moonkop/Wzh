...
static void run_self_test(void)
{
	...
	//	LCD_printf("setting bias succesfully ......\n");
    }
	else
	{
	//	LCD_printf("bias has not been modified ......\n");
	}
...
void _Mpu_Init(u8 mode)
{
    ...
    {   
        //LCD_printf("mpu initialization complete......\n ");
        
        //mpu_set_sensor
        if(!mpu_set_sensors(INV_XYZ_GYRO | INV_XYZ_ACCEL))
        {
            //LCD_printf("mpu_set_sensor complete ......\n");
        }
        else
        {
            //LCD_printf("mpu_set_sensor come across error ......\n");
        }
        
        //mpu_configure_fifo
        if(!mpu_configure_fifo(INV_XYZ_GYRO | INV_XYZ_ACCEL))
        {
            //LCD_printf("mpu_configure_fifo complete ......\n");
        }
        else
        {
            //LCD_printf("mpu_configure_fifo come across error ......\n");
        }
        
        //mpu_set_sample_rate
        if(!mpu_set_sample_rate(DEFAULT_MPU_HZ))
        {
            //LCD_printf("mpu_set_sample_rate complete ......\n");
        }
        else
        {
            //LCD_printf("mpu_set_sample_rate error ......\n");
        }
        
        //dmp_load_motion_driver_firmvare
        if(!dmp_load_motion_driver_firmware())
        {
            //LCD_printf("dmp_load_motion_driver_firmware complete ......\n");
        }
        else
        {
            //LCD_printf("dmp_load_motion_driver_firmware come across error ......\n");
        }
        
        //dmp_set_orientation
        if(!dmp_set_orientation(inv_orientation_matrix_to_scalar(gyro_orientation)))
        {
            //LCD_printf("dmp_set_orientation complete ......\n");
        }
        else
        {
            //LCD_printf("dmp_set_orientation come across error ......\n");
        }
        ...
        {
            //LCD_printf("dmp_enable_feature complete ......\n");
        }
        else
        {
            //LCD_printf("dmp_enable_feature come across error ......\n");
        }
        
        //dmp_set_fifo_rate
        if(!dmp_set_fifo_rate(DEFAULT_MPU_HZ))
        {
           //LCD_printf("dmp_set_fifo_rate complete ......\n");
        }
        else
        {
            //LCD_printf("dmp_set_fifo_rate come across error ......\n");
        }
        ...
        {
            //LCD_printf("mpu_set_dmp_state complete ......\n");
        }
        else
        {
            //LCD_printf("mpu_set_dmp_state come across error ......\n");
        }
